...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "VideoFlint"
  # s.authors            = { "VideoFlint" => "vvitozhang@gmail.com" }
  # s.social_media_url   = "http://twitter.com/VideoFlint"
  ...
  s.source       = { :git => "https://github.com/VideoFlint/VIWaveformView.git", :commit => "ecaa91dc6cbbc787bfafdc7ecfe1ec2e135f2d22" }
  ...
  s.source_files  = "VIWaveformView/Sources/*.{swift}"
